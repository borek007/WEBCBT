...
const RelationshipsPage = (props) => {
  ...
  const moodtestname = "Relationships";
      ...
      <div className="rounded-lg bg-white py-8 px-4 shadow-lg  sm:mx-auto sm:px-10">
        <div className="sm:mx-auto sm:w-full sm:max-w-2xl">
          ...
          <h1 className="mt-6 text-center font-serif text-xl tracking-wide text-gray-900">
            Think about an important relationship, like your spouse, partner,
            friend, colleague, or family member. Indicate how you feel about
            this relationship.
          </h1>
        </div>
        <div className="mt-8 font-serif sm:mx-auto sm:w-full sm:max-w-2xl">
          <div>
